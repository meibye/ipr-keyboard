...
| `ipr-provision.service` | `scripts/headless/ipr-provision.service` | `provision/04_enable_services.sh` | Permanent management hotspot on wlan0 (always-on; no cable required) |
