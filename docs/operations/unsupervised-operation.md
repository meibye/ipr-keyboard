...
| Where | What |
|---|---|
| Status LED | **red solid** when a core service (`bluetooth`, `bt_hid_ble`, `bt_hid_agent_unified`) is not active — checked every few seconds while the LED is on; tap the magnet to see it |
