...
ExecStart=
ExecStart=/usr/libexec/bluetooth/bluetoothd --experimental --noplugin=sap,avrcp,a2dp,bap,midi,network,health,wiimote,sixaxis,neard,autopair,battery,input,deviceinfo
EOF
