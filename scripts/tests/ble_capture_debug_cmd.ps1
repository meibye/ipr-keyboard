...
try {
    "==== BEGIN 2026-04-12T15:48:18.5612478+02:00 ====" | Out-File -FilePath "C:\Temp\ble_capture_start_full.log" -Encoding UTF8 -Append
    ...
    "==== END 2026-04-12T15:48:18.5612839+02:00 ====" | Out-File -FilePath "C:\Temp\ble_capture_start_full.log" -Encoding UTF8 -Append
